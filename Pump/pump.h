...
class Pump : public NullFederateAmbassador {
public:
    Pump(const std::wstring& federation_name, const std::wstring& federate_name);
    ...
    void sendNewAtrs(const rti1516e::LogicalTime& time);
